          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildDrawerItem(context, Icons.home, 'Inicio', 0, textColor),
                const Divider(),
                _buildDrawerItem(context, Icons.settings, 'Filamentos', 1, textColor),
                _buildDrawerItem(context, Icons.monetization_on, 'Costos Base', 2, textColor),
                _buildDrawerItem(context, Icons.percent, 'Impuestos y Márgenes', 3, textColor),
                _buildDrawerItem(context, Icons.attach_money, 'Calcular Venta', 4, textColor),
              ],
            ),
          ),
